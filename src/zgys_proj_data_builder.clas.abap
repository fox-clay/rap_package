CLASS ZGYS_PROJ_DATA_BUILDER DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZGYS_PROJ_DATA_BUILDER IMPLEMENTATION.
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zgys_proj_bp,
           lt_prod type table of zgys_proj_prod.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zgys_proj_bp from table @lt_bp.
     insert zgys_proj_prod from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zats_ps_dte_id,
           lt_so type table of zats_ps_so_hdr,
           lt_so_i type table of zats_ps_so_item.
    ...
    select * from zgys_proj_bp into table @data(lt_bpa).
    select * from zgys_proj_prod into table @data(lt_prod).
    ...
    insert zgys_proj_so_hdr from table @lt_so.
    insert zgys_proj_so_itm from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zgys_proj_bp, zgys_proj_prod, zgys_proj_so_hdr, zgys_proj_so_itm.
  ENDMETHOD.
ENDCLASS.
